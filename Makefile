...
# $(error HAVE_VENDOR_COMMON_LIB: $(HAVE_VENDOR_COMMON_LIB)) 
...
# $(error $(wildcard $(obj)include/config.mk))
all $(obj)u-boot.srec $(obj)u-boot.bin $(obj)u-boot \
...
backup:
	...
	tar --force-local -cjvf `LC_ALL=C date "+$$F-%Y-%m-%d-%T.tar.bz2"` $$F
